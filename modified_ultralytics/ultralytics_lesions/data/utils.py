...
from ultralytics_lesions.utils.checks import check_file, check_font, is_ascii
from ultralytics_lesions.utils.downloads import download, safe_download, unzip_file
from ultralytics_lesions.utils.ops import segments2boxes
...
def visualize_image_annotations(image_path, txt_path, label_map):
    ...
    from ultralytics_lesions.utils.plotting import colors
...
class HUBDatasetStats:
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                ...
                from ultralytics_lesions.data import YOLODataset
    ...
    def process_images(self):
        ...
        from ultralytics_lesions.data import YOLODataset  # ClassificationDataset
