...
from ultralytics_lesions.cfg import TASK2DATA, get_cfg
from ultralytics_lesions.data import build_dataloader
from ultralytics_lesions.data.dataset import YOLODataset
from ultralytics_lesions.data.utils import check_cls_dataset, check_det_dataset
from ultralytics_lesions.nn.autobackend import check_class_names, default_class_names
from ultralytics_lesions.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from ultralytics_lesions.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from ultralytics_lesions.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_COLAB,
    IS_JETSON,
...
from ultralytics_lesions.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from ultralytics_lesions.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ultralytics_lesions.utils.export import export_engine, export_onnx
from ultralytics_lesions.utils.files import file_size, spaces_in_path
from ultralytics_lesions.utils.ops import Profile, nms_rotated, xywh2xyxy
from ultralytics_lesions.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from ultralytics_lesions.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics_lesions.utils.tal import make_anchors
