...
from ultralytics_lesions.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_lesions.engine.results import Results
from ultralytics_lesions.hub import HUB_WEB_ROOT, HUBTrainingSession
from ultralytics_lesions.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        from ultralytics_lesions import __version__
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_lesions.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_lesions.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_lesions.utils.tuner import run_ray_tune
