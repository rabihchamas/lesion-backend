...
from ultralytics_lesions.data import YOLOConcatDataset, build_dataloader, build_yolo_dataset
from ultralytics_lesions.data.augment import LoadVisualPrompt
from ultralytics_lesions.data.utils import check_det_dataset
from ultralytics_lesions.models.yolo.detect import DetectionValidator
from ultralytics_lesions.models.yolo.model import YOLOEModel
from ultralytics_lesions.models.yolo.segment import SegmentationValidator
from ultralytics_lesions.nn.modules.head import YOLOEDetect
from ultralytics_lesions.utils import LOGGER, TQDM
from ultralytics_lesions.utils.torch_utils import select_device, smart_inference_mode
    ...
    def __call__(self, trainer=None, model=None, refer_data=None, load_vp=False):
        ...
        if trainer is not None:
            ...
            if isinstance(model, str):
                from ultralytics_lesions.nn.tasks import attempt_load_weights
