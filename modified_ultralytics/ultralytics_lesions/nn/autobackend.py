...
from ultralytics_lesions.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from ultralytics_lesions.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from ultralytics_lesions.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # TF GraphDef
            ...
            from ultralytics_lesions.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from ultralytics_lesions.utils.triton import TritonRemoteModel
