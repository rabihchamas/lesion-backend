...
from ultralytics_lesions.nn.autobackend import check_class_names
from ultralytics_lesions.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics_lesions.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_lesions.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_lesions.utils.loss import (
    E2EDetectLoss,
...
from ultralytics_lesions.utils.ops import make_divisible
from ultralytics_lesions.utils.plotting import feature_visualization
from ultralytics_lesions.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_lesions.models.utils.loss import RTDETRDetectionLoss
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False, without_reprta=False):
        ...
        """
        from ultralytics_lesions.nn.text_model import build_text_model
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_lesions.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_lesions.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    """
    from ultralytics_lesions.utils.downloads import attempt_download_asset
