...
from ultralytics_lesions.utils.patches import imread, imshow, imwrite, torch_load, torch_save  # for patches
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from ultralytics_lesions.utils.torch_utils import torch_distributed_zero_first
