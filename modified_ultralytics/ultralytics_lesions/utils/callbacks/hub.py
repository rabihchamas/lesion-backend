...
from ultralytics_lesions.hub import HUB_WEB_ROOT, PREFIX, HUBTrainingSession, events
from ultralytics_lesions.utils import LOGGER, RANK, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session := getattr(trainer, "hub_session", None):
        ...
        if trainer.epoch == 0:
            from ultralytics_lesions.utils.torch_utils import model_info_for_loggers
