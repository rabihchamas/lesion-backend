...
def check_yolo(verbose=True, device=""):
    ...
    from ultralytics_lesions.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ultralytics_lesions.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_lesions.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> check_amp(model)
    """
    from ultralytics_lesions.utils.torch_utils import autocast
